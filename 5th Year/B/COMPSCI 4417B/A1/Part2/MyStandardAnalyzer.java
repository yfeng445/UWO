...
public final class MyStandardAnalyzer extends StopwordAnalyzerBase {
    ...
    private static final List<String> CUSTOM_STOP_WORDS_LIST = Arrays.asList(
            "about", "dost", "from", "hath", "his", "O", "that", "the", "thou"
    );
    private static final CharArraySet CUSTOM_STOP_WORDS_SET = new CharArraySet(CUSTOM_STOP_WORDS_LIST, false);
...
protected TokenStreamComponents createComponents(String fieldName) {
    ...
    result = new StopFilter(result, CUSTOM_STOP_WORDS_SET); // Apply custom stopword list
    result = new PorterStemFilter(result); // Apply Porter stemming
